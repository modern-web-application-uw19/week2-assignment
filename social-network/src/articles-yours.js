...
export default class YourArticle extends Component {
    /* I recieve the following warning on this .js file as well as articles-missed.js and articles-view.js:
    *
    * 'Useless constructor  no-useless-constructor'
    * 
    * Am i not utilizing my constructor functon correctly?
    */
